...
//定义所需异步组件
// const AsyncIntroPart = defineAsyncComponent({
//   loader: () => import('../components/Homeitems/A_IntroPart.vue') // 组件加载器
// })
// const AsyncIntroNextPart = defineAsyncComponent({
//   loader: () => import('../components/Homeitems/B_IntroNextPart.vue') // 组件加载器
// })
// const AsyncExplainContainer = defineAsyncComponent({
//   loader: () => import('../components/Homeitems/C_ExplainContainer.vue') // 组件加载器
// })
</script>
